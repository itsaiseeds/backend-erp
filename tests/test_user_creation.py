"""ORM-backed tests for the admin / salesperson creation and utilities endpoints.
...
class CityUtilitiesTest(DMLTestCase):
    ...
    tests/test_user_creation.py::CityUtilitiesTest
    """
    ...
    def test_cities_requires_superuser(self):
        """tests/test_user_creation.py::CityUtilitiesTest::test_cities_requires_superuser"""
        # Anonymous
    ...
    def test_cities_grouped_by_state(self):
        """tests/test_user_creation.py::CityUtilitiesTest::test_cities_grouped_by_state"""
        self._auth_as(self.superuser)
