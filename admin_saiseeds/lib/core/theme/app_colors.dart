...
class AppColors {
  ...
  static const Color SIDEBAR_ICON_ACTIVE = Color(0xFF1E7A34);
  static const Color SIDEBAR_ITEM_SELECTED = Color(0xFFE9F2EB);
  static const Color SIDEBAR_PROFILE_BG = Color(0xFFEFF6F0);
  static const Color SIDEBAR_ON_PRIMARY_MUTED = Color(0xFFCFE2D4);
