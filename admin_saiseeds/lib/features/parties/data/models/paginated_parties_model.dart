...
class PaginatedPartiesModel {
  ...
  factory PaginatedPartiesModel.fromJson(Map<String, dynamic> json) {
    return PaginatedPartiesModel(
      ...
      results: _listOf(json['results'], PartyModel.fromJson),
