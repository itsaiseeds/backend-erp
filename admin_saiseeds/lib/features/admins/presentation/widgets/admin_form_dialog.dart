...
class _AdminFormDialogState extends State<AdminFormDialog> {
  ...
  void initState() {
    super.initState();
    final AdminModel? admin = widget.admin;
  ...
  Future<void> _submit() async {
    ...
    final bool succeeded = _isEditing
        ? await cubit.updateAdmin(
            id: widget.admin!.id,
            name: _nameController.text.trim(),
            phoneNumber: _phoneController.text.trim(),
            email: email.isEmpty ? null : email,
          )
        : await cubit.createAdmin(
            name: _nameController.text.trim(),
            phoneNumber: _phoneController.text.trim(),
    ...
    if (succeeded) {
      ...
      ToastUtils.showSuccess(
        context,
        _isEditing
            ? AppStrings.ADMIN_UPDATED_TITLE
            : AppStrings.ADMIN_CREATED_TITLE,
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    return AppFormDialog(
      ...
      title: _isEditing ? AppStrings.EDIT_ADMIN : AppStrings.ADD_ADMIN,
      subtitle: _isEditing
          ? AppStrings.EDIT_ADMIN_SUBTITLE
          : AppStrings.ADD_ADMIN_SUBTITLE,
