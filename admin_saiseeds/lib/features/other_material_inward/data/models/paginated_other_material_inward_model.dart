...
import 'other_material_inward_model.dart';

class PaginatedOtherMaterialInwardModel {
  final int totalCount;
  final int totalPages;
  final int? nextPageNumber;
  final int? previousPageNumber;
  final List<OtherMaterialInwardModel> results;
  final List<ClientFilterModel> availableFilters;
  final List<ClientSortModel> availableSorts;

  const PaginatedOtherMaterialInwardModel({
    this.totalCount = 0,
    this.totalPages = 0,
    this.nextPageNumber,
  ...
  factory PaginatedOtherMaterialInwardModel.fromJson(
    Map<String, dynamic> json,
  ) {
    return PaginatedOtherMaterialInwardModel(
      ...
      results: _listOf(json['results'], OtherMaterialInwardModel.fromJson),
