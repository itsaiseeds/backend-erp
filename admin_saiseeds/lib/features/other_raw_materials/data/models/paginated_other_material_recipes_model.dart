...
import 'other_material_recipe_model.dart';

class PaginatedOtherMaterialRecipesModel {
  final int totalCount;
  final int totalPages;
  final int? nextPageNumber;
  final int? previousPageNumber;
  final List<OtherMaterialRecipeModel> results;
  final List<ClientFilterModel> availableFilters;
  final List<ClientSortModel> availableSorts;

  const PaginatedOtherMaterialRecipesModel({
    this.totalCount = 0,
    this.totalPages = 0,
    this.nextPageNumber,
  ...
  factory PaginatedOtherMaterialRecipesModel.fromJson(
    Map<String, dynamic> json,
  ) {
    return PaginatedOtherMaterialRecipesModel(
      ...
      results: _listOf(json['results'], OtherMaterialRecipeModel.fromJson),
