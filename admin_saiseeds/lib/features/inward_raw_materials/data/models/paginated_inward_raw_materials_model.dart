...
import 'inward_raw_material_model.dart';

class PaginatedInwardRawMaterialsModel {
  final int totalCount;
  final int totalPages;
  final int? nextPageNumber;
  final int? previousPageNumber;
  final List<InwardRawMaterialModel> results;
  final List<ClientFilterModel> availableFilters;
  final List<ClientSortModel> availableSorts;

  const PaginatedInwardRawMaterialsModel({
    this.totalCount = 0,
    this.totalPages = 0,
    this.nextPageNumber,
  ...
  factory PaginatedInwardRawMaterialsModel.fromJson(Map<String, dynamic> json) {
    return PaginatedInwardRawMaterialsModel(
      ...
      results: _listOf(json['results'], InwardRawMaterialModel.fromJson),
